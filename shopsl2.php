...
<html>
	...
	<body class="homepage">
       ...
       <div id="main-wrapper">
                    ...
                    <li><a href="smartlife-shopsl1.php?brand=<?php echo $_GET["name"]; ?>" class="sideCircleShopSelected">1</a><p>Personal Info</p></li>
			...
			<!-- Banner -->
				<div id="infoWrapper">
                    ...
                    <select name='expireYY' id='expireYY'>
                       ...
                       <br> <a href="shopsl3.php?name=<?php echo $_GET["name"]; ?>" class = "button"> Submit </a> <br><br>
                    </form>
