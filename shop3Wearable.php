                                ...
                                <div id="sidebar">
                                    <section>
                                        <ul>
                                            ...
                                            <li><a href="shop1Wearable.php?brand=<?php echo $_GET["brand"]; ?>&model=<?php echo $_GET["model"]; ?>" class="sideCircleShopSelected">1</a><p>Info</p></li>
                                            <li><a href="shop2Wearable.php?brand=<?php echo $_GET["brand"]; ?>&model=<?php echo $_GET["model"]; ?>" class="sideCircleShopSelected">2</a><p>Payment</p></li>
