...
<html>
	...
	<body class="homepage">
		<div id="page-wrapper">
									...
									<!-- Sidebar -->
										<section>
                                               <ul>
                                                   ...
                                                   <li><a class="notAllowed">Available SL services</a></li>
                                                   <li><a class="notAllowed">Available Assistance Service</a></li>
                                               </ul>
										</section>
								</div>
							</div>
								...
								<div id="content">
									...
									<!-- Content -->
										<article>
                                            <section>
                                               <ul>
                                                   <li><a href="Wearables-presentation.php?brand=<?php echo $_GET["brand"]; ?>&model=<?php echo $_GET["model"]; ?>" class = "selected">Presentation</a></li>
                                                   <li><a href="Wearables-characteristics.php?brand=<?php echo $_GET["brand"]; ?>&model=<?php echo $_GET["model"]; ?>" class = "button">Technical Characteristics</a></li>
                                               </ul>
                                            </section>
            ...
            <script src="assets/js/WearablesInfo.js"></script>
	</body>
</html>