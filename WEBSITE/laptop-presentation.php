...
<html>
	...
	<body class="homepage">
		<div id="page-wrapper">
							...
							<div class="4u 12u(medium)">
								<div id="sidebar">
									...
									<!-- Sidebar -->
										<section>
                                               <ul>
                                                    <li><a href="laptop&desktop.html">Laptop & Desktop</a></li>
                                                    <li><a class="notAllowed">Available Sl service</a></li>
                                                   <li><a href="availableAssistanceServicesLaptop.php?brand=<?php echo $_GET["brand"];?>&model=<?php echo $_GET["model"]; ?>">Available Assistance Service</a></li>
                                               </ul>
										</section>
								</div>
							</div>
								...
								<div id="content">
									...
									<!-- Content -->
										<article>
                                            <section>
                                               <ul>
                                                   <li><a href="laptop-presentation.php?brand=<?php echo $_GET["brand"]; ?>&model=<?php echo $_GET["model"]; ?>" class = "selected">Presentation</a></li>
                                                   <li><a href="laptop-characteristics.php?brand=<?php echo $_GET["brand"]; ?>&model=<?php echo $_GET["model"]; ?>" class = "button">Technical Characteristics</a></li>
                                               </ul>
                                            </section>
            ...
            <script src="assets/js/laptopInfo.js"></script>
	</body>
</html>