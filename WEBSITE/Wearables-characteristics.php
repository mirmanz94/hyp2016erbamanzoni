...
<html>
	...
	<body class="homepage">
		<div id="page-wrapper">
								...
								<div id="content">
									...
									<!-- Content -->
										<article>
                                            <section>
                                               <ul>
                                                   <li><a href="Wearables-presentation.php?brand=<?php echo $_GET["brand"]; ?>&model=<?php echo $_GET["model"]; ?>">Presentation</a></li>
                                                   <li><a href="Wearables-characteristics.php?brand=<?php echo $_GET["brand"]; ?>&model=<?php echo $_GET["model"]; ?>"  class="selected">Technical Characteristics</a></li>
                                               </ul>
                                            </section>
            ...
            <script src="assets/js/WearablesCharacteristics.js"></script>
	</body>
</html>