$(window).load(function(){
    ...
    $.ajax({
        ...
        url: "http://www.hyp2016erbamanzoni.altervista.org/assets/php/laptopCharacteristicsQuery.php?brand=" + brand +"&model=" + model, //Relative or absolute path to file.php file
