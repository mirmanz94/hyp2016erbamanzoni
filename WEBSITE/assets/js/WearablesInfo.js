$(window).load(function(){
    ...
    $.ajax({
        ...
        url: "http://www.hyp2016erbamanzoni.altervista.org/assets/php/WearablesInfoQuery.php?brand=" + brand +"&model=" + model, //Relative or absolute path to file.php file
        ...
        success: function(response) {
            ...
            var returnString;
            returnString = "<a class=image featured><img src=" + results[0].image + "></a><section class=box feature text><h2>" + results[0].price + "€</h2></section><a href=shop1Wearable.php?brand=" + results[0].brand + "&model=" + results[0].name + " class=image feature><img src=/images/high-gloss-purchase-blue-00.png></a>";
