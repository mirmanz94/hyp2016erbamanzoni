$(window).load(function(){
    ...
    $.ajax({
        ...
        url: "http://www.hyp2016erbamanzoni.altervista.org/assets/php/laptopInfoQuery.php?brand=" + brand +"&model=" + model, //Relative or absolute path to file.php file
        ...
        success: function(response) {
            ...
            var returnString;
            returnString = "<a class=image featured><img src=" + results[0].image4 + "></a><section class=box feature text><h2>" + results[0].price + "€</h2></section><a href=shop1Laptop.php?brand=" + results[0].brand + "&model=" + results[0].name + " class=image feature><img src=/images/high-gloss-purchase-blue-00.png></a>";
            
            var presentation = results[0].presentation;
            console.log(presentation);
            var images = [results[0].image2,results[0].image3];
