								...
								<div id="content">
									...
									<!-- Content -->
										<article>
                                            <section>
                                               <ul>
                                                   <li><a href="smartlife-description.php?name=<?php echo $_GET["name"]; ?>" class = "button">Description</a></li>
                                                   <li><a href="smartlife-activation.php?name=<?php echo $_GET["name"]; ?>" class = "selected">Activation & Rules</a></li>
