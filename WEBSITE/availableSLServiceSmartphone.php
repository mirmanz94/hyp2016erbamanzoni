...
<html>
	...
	<body class="homepage">
		<div id="page-wrapper">
			...
			<!-- Banner -->
                <div id="main-wrapper" class="loadingImage">
            <div class="container">
                           <article>
                                <h2>Available SL Service For <?php echo $_GET["brand"]; ?> <?php echo $_GET["model"]; ?></h2>
                            </article>
							...
							<div class="4u 12u(medium)">
								<div id="content">
									<section class="box feature">
                                        <ul>
                                            <li>
                                                 <a href="smartlife-description.php?name=TIMSmartPayments"><br><br>TIM Smart Pay<br><br></br></a>
                                            </li>
                                            <li> <a class = "notAllowed"><br><br>TIM Music<br><br></br></a></li>
                                        </ul>                                       
									</section>
                                </div>
                            </div>
