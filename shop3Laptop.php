						...
						<div class="row">
							<div class="4u 12u$(medium)">
                                <div id="sidebar">
                                    <section>
                                        <ul>
                                            <li><a href="laptop-presentation.php?brand=<?php echo $_GET["brand"]; ?>&model=<?php echo $_GET["model"]; ?>">Back to <?php echo $_GET["brand"]; ?> <?php echo $_GET["model"]; ?></a></li>  
                                            <li><a href="shop1Laptop.php?brand=<?php echo $_GET["brand"]; ?>&model=<?php echo $_GET["model"]; ?>" class="sideCircleShopSelected">1</a><p>Info</p></li>
                                            <li><a href="shop2Laptop.php?brand=<?php echo $_GET["brand"]; ?>&model=<?php echo $_GET["model"]; ?>" class="sideCircleShopSelected">2</a><p>Payment</p></li>
