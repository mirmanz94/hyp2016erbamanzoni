...
<html>
	...
	<body class="homepage">
		<div id="page-wrapper">
            ...
            <div class="container">
                           <article>
                                <h2>Available Assistance Services For <?php echo $_GET["brand"]; ?> <?php echo $_GET["model"]; ?></h2>
                            </article>
							...
							<div class="4u 12u(medium)">
								<div id="content">
									<section class="box feature">
                                        <ul>
                                            <li>
                                                 <a href="Problem%20Viewing%20Content.html"><br><br>Problem Viewing Content<br><br></br></a>
                                            </li>
                                        </ul>                                       
									</section>
                                </div>
