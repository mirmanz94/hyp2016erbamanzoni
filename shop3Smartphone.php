						...
						<div class="row">
							<div class="4u 12u$(medium)">
                                <div id="sidebar">
                                    <section>
                                        <ul>
                                            <li><a href="smartphone-presentation.php?brand=<?php echo $_GET["brand"]; ?>&model=<?php echo $_GET["model"]; ?>">Back to <?php echo $_GET["brand"]; ?> <?php echo $_GET["model"]; ?></a></li>  
                                            <li><a href="shop1Smartphone.php?brand=<?php echo $_GET["brand"]; ?>&model=<?php echo $_GET["model"]; ?>" class="sideCircleShopSelected">1</a><p>Info</p></li>
                                            <li><a href="shop2Smartphone.php?brand=<?php echo $_GET["brand"]; ?>&model=<?php echo $_GET["model"]; ?>" class="sideCircleShopSelected">2</a><p>Payment</p></li>
                                            <li><a class="sideCircleShopSelected">3</a><p>Complete</p></li>               
                                        </ul>
                                    </section>
                                </div>
                            </div>
                    ...
                    <div id="infoWrapper">
                		...
                		<div class="8u 12u$(medium) important(medium)">
								<div id="content">
									...
									<!-- Content -->
										<article>
                                              <br><br><p>Transaction Completed<br>You will receive an e-mail to track your pack. <br> Thank you for using our services.</p>
										</article>
                                     <a href="index.html" class = "button"> go to the HomePage </a> <br><br><br>
