...
<html>
	...
	<body class="homepage">
		...
		<div id="main-wrapper">
								...
								<div id="content">
									...
									<!-- Content -->
										<article>
                                            <section>
                                               <ul>
                                                   <li><a href="TV-presentation.php?brand=<?php echo $_GET["brand"]; ?>&model=<?php echo $_GET["model"]; ?>">Presentation</a></li>
                                                   <li><a href="TV-characteristics.php?brand=<?php echo $_GET["brand"]; ?>&model=<?php echo $_GET["model"]; ?>"  class = "selected">Technical Characteristics</a></li>
                                               </ul>
                                            </section>
            ...
            <script src="assets/js/TVCharacteristics.js"></script>
	</body>
</html>