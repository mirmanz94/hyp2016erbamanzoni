...
<html>
	...
	<body class="homepage">
		<div id="page-wrapper">
								...
								<div id="content">
									...
									<!-- Content -->
										<article>
                                            <section>
                                               <ul>
                                                   <li><a href="smartlife-description.php?name=<?php echo $_GET["name"]; ?>" class = "selected">Description</a></li>
                                                   <li><a href="smartlife-activation.php?name=<?php echo $_GET["name"]; ?>" class = "button">Activation & Rules</a></li>
                                                   <li><a href="smartlife-faq.php?name=<?php echo $_GET["name"]; ?>" class = "button">FAQ</a></li>
                                               </ul>
                                            </section>
											<h2><?php echo $_GET["name"]; ?></h2>
											<div class="name" id=<?php echo $_GET["name"]; ?>>
            ...
            <script src="assets/js/smartlifeDescription.js"></script>
	</body>
</html>