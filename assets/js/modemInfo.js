$(window).load(function(){
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            var returnString;
            returnString = "<a class=image featured><img src=" + results[0].image1 + "></a><section class=box feature text><h2>" + results[0].price + "€</h2></section><a href=shop1Modem.php?brand=" + results[0].brand + "&model=" + results[0].name + " class=image feature><img src=/images/high-gloss-purchase-blue-00.png></a>";
