...
<html>
	...
	<body class="homepage">
		<div id="page-wrapper">
								...
								<div id="sidebar">
									...
									<!-- Sidebar -->
										<section>
                                               <ul>
                                                    <li><a href="smartphone&tablet.html">Smartphone & Tablet</a></li>
                                                   <li><a href="availableSLServiceSmartphone.php?brand=<?php echo $_GET["brand"]; ?>&model=<?php echo $_GET["model"]; ?>">Available SL services</a></li>
                                                   <li><a href="availableAssistanceServicesSmartphone.php?brand=<?php echo $_GET["brand"];?>&model=<?php echo $_GET["model"]; ?>">Available Assistance Service</a></li>
                                               </ul>
										</section>
								</div>
							</div>
								...
								<div id="content">
									...
									<!-- Content -->
										<article>
                                            <section>
                                               <ul>
                                                   <li><a href="smartphone-presentation.php?brand=<?php echo $_GET["brand"]; ?>&model=<?php echo $_GET["model"]; ?>" class = "selected">Presentation</a></li>
                                                   <li><a href="smartphone-characteristics.php?brand=<?php echo $_GET["brand"]; ?>&model=<?php echo $_GET["model"]; ?>" class = "button">Technical Characteristics</a></li>
                                               </ul>
                                            </section>
            ...
            <script src="assets/js/smartphoneInfo.js"></script>
	</body>
</html>