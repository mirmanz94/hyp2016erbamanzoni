...
<html>
	...
	<body class="homepage">
       ...
       <div id="main-wrapper">
                    ...
                    <li><a href="#" class="sideCircleShopSelected">1</a><p>Personal Info</p></li>
                    <li><a href="#" class="sideCircleShop">2</a><p>Payment</p></li>
                    <li><a href="#" class="sideCircleShop">3</a><p>Complete</p></li>
                </ul>
            </section>
        </div>  
        </div>
			...
			<!-- Banner -->
                <div id = "infoWrapper">
                    <form>
                        ...
                        <br> <a href="shopsl2.php?name=<?php echo $_GET["name"]; ?>" class = "button"> Submit </a> <br>
                    </form>
                </div>
			<!-- Footer -->
