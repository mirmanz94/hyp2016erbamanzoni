						...
						<div class="row">
							<div class="4u 12u$(medium)">
                                <div id="sidebar">
                                    <section>
                                        <ul>
                                                <li><a href="smartlife-description.php?name=<?php echo $_GET["name"]; ?>">Back to <?php echo $_GET["name"]; ?></a></li> 
                                                <li><a href="smartlife-shopsl1.php?name=<?php echo $_GET["name"]; ?>" class="sideCircleShopSelected">1</a><p>Personal Info</p></li>
                                                 <li><a href="smartlife-shopsl2.php?name=<?php echo $_GET["name"]; ?>" class="sideCircleShopSelected">2</a><p>Payment</p></li>
                		...
                		<div class="8u 12u$(medium) important(medium)">
								<div id="content">
									...
									<!-- Content -->
                                     ...
                                     <a href="index.html" class = "button"> Continue Shopping </a> <br><br><br><br><br><br>
