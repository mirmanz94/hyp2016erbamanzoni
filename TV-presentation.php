...
<html>
	...
	<body class="homepage">
		<div id="page-wrapper">
								...
								<div id="sidebar">
									...
									<!-- Sidebar -->
										<section>
                                               <ul>
                                                    <li><a href="TV.html">TV</a></li>
                                                   <li><a href="availableSLServiceTV.php?brand=<?php echo $_GET["brand"]; ?>&model=<?php echo $_GET["model"]; ?>">Available SL services</a></li>
                                                   <li><a href="availableAssistanceServicesTV.php?brand=<?php echo $_GET["brand"];?>&model=<?php echo $_GET["model"]; ?>">Available Assistance Service</a></li>
                                               </ul>
										</section>
								</div>
							</div>
								...
								<div id="content">
									...
									<!-- Content -->
										<article>
                                            <section>
                                               <ul>
                                                   <li><a href="TV-presentation.php?brand=<?php echo $_GET["brand"]; ?>&model=<?php echo $_GET["model"]; ?>" class = "selected">Presentation</a></li>
                                                   <li><a href="TV-characteristics.php?brand=<?php echo $_GET["brand"]; ?>&model=<?php echo $_GET["model"]; ?>" class = "button">Technical Characteristics</a></li>
                                               </ul>
                                            </section>
            ...
            <script src="assets/js/TVInfo.js"></script>
	</body>
</html>